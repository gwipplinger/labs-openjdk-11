...
import static jdk.vm.ci.i386.I386.eax;
import static jdk.vm.ci.i386.I386.ecx;
import static jdk.vm.ci.i386.I386.edi;
import static jdk.vm.ci.i386.I386.edx;
import static jdk.vm.ci.i386.I386.esi;
import static jdk.vm.ci.i386.I386.esp;
...
public class I386HotSpotRegisterConfig implements RegisterConfig {
    ...
    private static final RegisterArray reservedRegisters = new RegisterArray(esp);
    ...
    public I386HotSpotRegisterConfig(TargetDescription target, RegisterArray allocatable, boolean windowsOS) {
        ...
        if (windowsOS) {
            javaGeneralParameterRegisters = new RegisterArray(edx, edi, esi, ecx);
            nativeGeneralParameterRegisters = new RegisterArray(ecx, edx);
            nativeXMMParameterRegisters = new RegisterArray(xmm0, xmm1, xmm2, xmm3);
            this.needsNativeStackHomeSpace = true;
        } else {
            javaGeneralParameterRegisters = new RegisterArray(esi, edx, ecx, edi);
            nativeGeneralParameterRegisters = new RegisterArray(edi, esi, edx, ecx);
